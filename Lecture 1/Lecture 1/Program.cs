...
//         static void Main(string[] args)
//         {
//             string untrimmed = "   Hello, World!   Hello World!   ";
...
//             bool containsFox = sentence.Contains("fox",StringComparison.OrdinalIgnoreCase);
...
//             string formattedDate = $"Today is {today:MMMM dd, yyyy}";
...
//             PrintMessage(); /* This is a multi-line comment
...
/* using System; - This line is a namespace
 directive that allows you to use types defined 
 in the System namespace.*/
/* namespace ExampleStructure - This defines a namespace 
called ExampleStructure which is used to organize your code.*/
/* class Program - This declares a class named Program.
 Classes are the building blocks of C# programs.*/
/* static void Main(string[] args) - 
This is the Main method, the entry point of the 
program where execution starts.*/
// Console.WriteLine("Understanding C# Structure"); - This is a statement that prints a string to the console.
...
//         static void Main(string[] args)
//         {
//             int books = 150; // int: 32-bit integer
//             long population = 70000000000000; // long: 64-bit integer
//             short year = 2024; // short: 16-bit integer
//             byte age = 30; // byte: 8-bit integer
//             float piFloat = 3.14f; // float: 32-bit floating-point number
//             double piDouble = 3.141592653589793; // double: 64-bit floating-point number
...
//             Console.WriteLine("Explicit Conversion from double to int: " + intPi);
//             double doubleNum = intPi; // Implicit conversion from int to double
//             Console.WriteLine("Implicit Conversion from int to double: " + doubleNum);
//         }
//     }
// }
